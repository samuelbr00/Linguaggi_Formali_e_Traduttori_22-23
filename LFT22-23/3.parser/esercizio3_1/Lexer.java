...
public class Lexer {// analizzatore lessicale che genera i token appartenenti ad una determinata sintassi
    ...
    //espressione regolare che accetta(ma anche stringhe errate) la sintassi degli "tag" in java e genera i token
//ogni token corrisponde ad un frammento della sintassi java 
//+ tokenizza anche i commenti nella sintassi java
    ...
    private void readch(BufferedReader br) { //metodo che si occupa di scorrere la stringa in input
        try {
            peek = (char) br.read();
